...
extractor_train = raw_train
extractor_val = raw_val
...
extractor_model_path = "/home/Student/s4819764/model-saves/unfiltered/extractor_{0}_{1}/extractor/savefile.hdf5".format(str(dataset), current_time)
